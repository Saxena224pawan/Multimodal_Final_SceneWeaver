#!/bin/bash -l
#SBATCH --job-name=vbench_lion_mouse
#SBATCH --output=../slurm_logs/vbench_lion_mouse_%j.out
#SBATCH --error=../slurm_logs/vbench_lion_mouse_%j.err
...
STORY_KEY="lion_and_mouse"
STORY_RUN_DIR="/home/vault/v123be/v123be36/sceneweaver_runs/lion_and_mouse_260319_225545"
