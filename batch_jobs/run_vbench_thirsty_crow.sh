#!/bin/bash -l
#SBATCH --job-name=vbench_thirsty_crow
#SBATCH --output=../slurm_logs/vbench_thirsty_crow_%j.out
#SBATCH --error=../slurm_logs/vbench_thirsty_crow_%j.err
...
STORY_KEY="thirsty_crow"
STORY_RUN_DIR="/home/vault/v123be/v123be36/sceneweaver_runs/thirsty_crow_260319_225546"
