#!/bin/bash -l
#SBATCH --job-name=vbench_tortoise_hare
#SBATCH --output=../slurm_logs/vbench_tortoise_hare_%j.out
#SBATCH --error=../slurm_logs/vbench_tortoise_hare_%j.err
...
STORY_KEY="tortoise_and_hare"
STORY_RUN_DIR="/home/vault/v123be/v123be36/sceneweaver_runs/tortoise_and_hare_260319_225652"
